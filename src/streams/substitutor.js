...
util.inherits(Substitutor, stream.Transform);

function Substitutor(options, tickProgressBar, opts) {
  stream.Transform.call(this, opts);

  this._from = new RegExp(options.find, "g");
  this._tickProgressBar = tickProgressBar;
  ...
  if (options.replace !== undefined) {
    ...
    console.log("Replacing %s with %s", this._from, options.replace);
  }
...
Substitutor.prototype._transform = function(chunk, _, doneProcessing) {
